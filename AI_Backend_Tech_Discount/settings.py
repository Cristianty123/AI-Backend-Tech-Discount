"""
Django settings for AI_Backend_Tech_Discount project.
...
ROOT_URLCONF = 'AI_Backend_Tech_Discount.urls'
...
WSGI_APPLICATION = 'AI_Backend_Tech_Discount.wsgi.application'
